...
pub fn oki_to_pcm_wave(bytes: &[u8]) -> Vec<u8> {
    let oki_context = AdpcmSetup::new_oki(); // Should be able to get other adpcm by changing this

    let mut result: Vec<u8> = vec![0x52, 0x49, 0x46, 0x46, 0x86, 0x45, 0x02, 0x00, 0x57, 0x41, 0x56, 0x45, 0x66, 0x6D, 0x74, 0x20, 0x10, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x40, 0x1F, 0x00, 0x00, 0x80, 0x3E, 0x00, 0x00, 0x02, 0x00, 0x10, 0x00, 0x4C, 0x49, 0x53, 0x54, 0x1A, 0x00, 0x00, 0x00, 0x49, 0x4E, 0x46, 0x4F, 0x49, 0x53, 0x46, 0x54, 0x0E, 0x00, 0x00, 0x00, 0x4C, 0x61, 0x76, 0x66, 0x35, 0x38, 0x2E, 0x34, 0x35, 0x2E, 0x31, 0x30, 0x30, 0x00, 0x64, 0x61, 0x74, 0x61, 0x40, 0x45, 0x02, 0x00]; // Stores the PCM byte array as it is built with a wave header at the start
